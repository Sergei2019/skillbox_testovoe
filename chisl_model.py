...
while t < T:
    ...
    dVy1 = (-sin(alpha * deg.scale_factor) - a * sin(alpha * deg.scale_factor) * Vy - b * sin(alpha * deg.scale_factor) * N(sqrt(Vx**2 + Vy**2) * Vy)) * dt
    ...
    dVx3 = (-a * sin(alpha * deg.scale_factor) * (Vx + dVx2/2) - b * sin(alpha * deg.scale_factor) * N(sqrt((Vx + dVx2/2)**2 + (Vy + dVy2/2)**2) * (Vx + dVx2/2))) * dt
    ...
    dVx4 = (-a * sin(alpha * deg.scale_factor) * (Vx + dVx3) - b * sin(alpha * deg.scale_factor) * N(sqrt((Vx + dVx3)**2 + (Vy + dVy3)**2) * (Vx + dVx3))) * dt
